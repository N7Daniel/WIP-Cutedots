...
def printOut(curves, title):
    ...
    n = len(avg)
    t = (np.arange(n)-n/2) * 0.1
    for time, value in zip(t, avg):
        print '%.3f\t%.3f' % (time, value)
    print ""

def phase1(arg1, arg2, arg3, arg4, arg5, arg6, arg7):
    print("im here")
    import pylab as pl
    all = []
    ...
    if args5 is not None:
        pl.savefig(arg5, dpi=600)
    else:
        pl.show()
